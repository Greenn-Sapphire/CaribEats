...
@section('content')
    <div class="container" style="margin-top: 80px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/menu">Tienda</a></li>
            ...
            <div class="col-lg-7">
                ...
                @foreach($cartCollection as $item)
                    <div class="row">
                        <div class="col-lg-3">
                            @if(isset($item->image))
                                <img src="{{asset('storage').'/'.$item->image}}" width="150" class="img-thumbnail img-fluid">
                            @endif
                        </div>
                        <div class="col-lg-5">
                            <p>
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <form action="{{ route('cart.remove') }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                    <button class="btn btn-dark btn-sm" style="margin-right: 10px;">Borrar</button>
                                </form>
                            </div>
                        </div>
                    </div>
